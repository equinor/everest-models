...
@patch("everest_models.jobs.fm_compute_economics.manager.EclipseSummary.get_summary")
@patch("everest_models.jobs.shared.models.wells.WellConfig.parse_file")
def test_npv_main_entry_point_output_currency_USD(
    mocker_well_config,
    mocker_summary,
    copy_testdata_tmpdir,
    monkeypatch,
...
@patch("everest_models.jobs.fm_compute_economics.manager.EclipseSummary.get_summary")
@patch("everest_models.jobs.shared.models.wells.WellConfig.parse_file")
def test_npv_main_entry_point_output_currency_USD_from_CLI(
    mocker_well_config,
    mocker_summary,
    copy_testdata_tmpdir,
    monkeypatch,
...
@patch("everest_models.jobs.fm_compute_economics.manager.EclipseSummary.get_summary")
def test_npv_main_entry_point_no_input_error(
    mocker_summary,
    copy_testdata_tmpdir,
    monkeypatch,
    capsys,
...
@patch("everest_models.jobs.fm_compute_economics.manager.EclipseSummary.get_summary")
@patch("everest_models.jobs.shared.models.wells.WellConfig.parse_file")
def test_npv_main_entry_point_no_input(
    mocker_well_config,
    mocker_summary,
    copy_testdata_tmpdir,
    monkeypatch,
